...
public class SVGElement extends Element {
    /** 
The value of the <code>id</code> attribute on the given element, or the empty string if <code>id</code> is not present. */
    public String id;
    ...
    /** <p>The nearest ancestor <code>&lt;svg&gt;</code> element. <code>Null</code> if the given element is the outermost svg element.</p>  */
    public SVGSVGElement ownerSVGElement;
    /** <p>The element which established the current viewport. Often, the nearest ancestor <code>&lt;svg&gt;</code> element. <code>Null</code> if the given element is the outermost svg element.</p>  */
