...
public class MSManipulationEvent extends UIEvent {
    ...
    native public void initMSManipulationEvent(String typeArg, Boolean canBubbleArg, Boolean cancelableArg, Window viewArg, double detailArg, double lastState, double currentState);
