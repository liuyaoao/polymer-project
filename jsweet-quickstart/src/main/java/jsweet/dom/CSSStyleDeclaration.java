package jsweet.dom;
/**  <p><code>CSSStyleDeclaration</code> represents a collection of CSS property-value pairs. It is used in a few APIs:</p> <ul> <li><code>HTMLElement.style</code> - to manipulate the style of a single element (&lt;elem style=&quot;...&quot;&gt;);</li> <li>(TODO: reword) is an interface to the declaration block returned by the <code>style</code> property of a <code>cssRule</code> in a stylesheet, when the&nbsp;rule is a CSSStyleRule.</li> <li><code>CSSStyleDeclaration</code> is also a <strong>read-only</strong> interface to the result of window.getComputedStyle().</li> </ul>  */
public class CSSStyleDeclaration extends jsweet.lang.Object implements Iterable<java.lang.String> {
 ...
 The containing <code>CssRule</code>.  */
    ...
    public String zoom;
    /** 
 Returns the optional priority, &quot;important&quot;. Example: <em>priString</em>= <em>styleObj</em>.getPropertyPriority('color')  */
    native public String getPropertyPriority(String propertyName);
    /** 
 Returns the property value. Example: <em>valString</em>= <em>styleObj</em>.getPropertyValue('color')  */
    native public String getPropertyValue(String propertyName);
    /** 
 Returns a property name. Example: <em>nameString</em>= <em>styleObj</em>.item(0) Alternative: <em>nameString</em>= <em>styleObj</em>[0]  */
    native public String item(double index);
    /** 
 Returns the value deleted. Example: <em>valString</em>= <em>styleObj</em>.removeProperty('color')  */
    native public String removeProperty(String propertyName);
    /** 
 No return. Example: <em>styleObj</em>.setProperty('color', 'red', 'important')  */
