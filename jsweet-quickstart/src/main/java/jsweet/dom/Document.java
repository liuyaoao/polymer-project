...
</pre> </div> <iframe></iframe> <p>The <code>Document</code> interface describes the common properties and methods for any kind of documentation. Depending on the kind of the document (e.g. HTML, XML, SVG, 鈥�), a larger API is available: HTML documents (e.g. those served with the <code>text/html</code> content type) also implement the <code>HTMLDocument</code> interface and SVG documents implement the <code>SVGDocument</code> interface.</p>  */
...
public class Document extends Node {
 ...
 Creates a new CDATA node and returns it.  */
     ...
     *  new add
     */
    native public void registerElement(String name,jsweet.lang.Object obj);
    /**
