package jsweet.dom;
/** <p>The <strong><code>HTMLBodyElement</code></strong> interface provides special properties (beyond those of the regular <code>HTMLElement</code> interface they also inherit) for manipulating body elements.</p>  */
public class HTMLBodyElement extends HTMLElement {
    /** 
 Is a <code>DOMString</code> that represents the color of active hyperlinks.  */
    public Object aLink;
    /** 
 Is a <code>DOMString</code> that represents the description of the location of the background image resource. Note that this is not an URI, though some older version of some browsers do expect it.  */
    public String background;
    /** 
 Is a <code>DOMString</code> that represents the background color for the document.  */
    public Object bgColor;
    public String bgProperties;
    /** 
 Is a <code>DOMString</code> that represents the color of unvisited links.  */
    public Object link;
    ...
    /** 
 Is a <code>DOMString</code> that represents the foreground color of text.  */
    public Object text;
    /** 
 Is a <code>DOMString</code> that represents the color of visited links.  */
    public Object vLink;
