package jsweet.dom;
/** <p>The <code><strong>HTMLSelectElement</strong></code> interface represents a <code>&lt;select&gt;</code> HTML Element. These elements also share all of the properties and methods of other HTML elements via the <code>HTMLElement</code> interface.</p>  */
public class HTMLSelectElement extends HTMLElement {
    ...
    /** 
 Is a <code>Boolean</code> that reflects the <code>disabled</code> HTML attribute, which indicates whether the control is disabled. If it is disabled, it does not accept clicks.  */
    ...
    public String name;
    /** 
 Returns a <code>HTMLOptionsCollection</code> containing the set of <code>&lt;option&gt;</code> elements contained by this element.  */
    ...
    /** 
 Returns a live <code>HTMLCollection</code> containing the set of options that are selected.  */
