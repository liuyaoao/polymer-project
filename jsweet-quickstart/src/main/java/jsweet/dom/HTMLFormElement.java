package jsweet.dom;
/** <p>The <strong><code>HTMLFormElement</code></strong> interface provides methods to create and modify <code>&lt;form&gt;</code> elements; it inherits from properties and methods of the <code>HTMLElement</code> interface.</p>  */
