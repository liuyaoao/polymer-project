...
REM * to SiteView's local folder or to Topaz's Graph Server local folder.									 *
REM * In order to be invoked by a SiteView script monitor, this file should reside under the 'templates.applications\scripts.siebel' directory  *
REM * of SiteView.		      	 													 * 
REM * 															      		      	 *
REM * Usage example: 															      	 *
REM * C:\SiteView\templates.applications\scripts.siebel\copy_remote_file.bat \\sblapp1\log\SCCObjMgr_enu_93480.log templates.eventlog		 *
REM * 															      		      	 *
REM **********************************************************************************************************************************************
