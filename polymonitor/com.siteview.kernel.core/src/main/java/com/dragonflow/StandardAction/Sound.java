...
public class Sound extends com.dragonflow.SiteView.Action
{
    ...
    public boolean execute()
    {
        ...
        try
        {
            String s2 = Platform.getUsedDirectoryPath("templates.sound", monitor.getProperty(com.dragonflow.SiteView.Monitor.pGroupID)) + java.io.File.separator + s1;
    ...
    static 
    {
        ...
        audioSleepTime = com.dragonflow.Utils.TextUtils.toInt(TextUtils.getValue(hashmap, "_AudioSleepTime"));
        if(audioSleepTime == 0)
        {
            audioSleepTime = 3000;
        }
