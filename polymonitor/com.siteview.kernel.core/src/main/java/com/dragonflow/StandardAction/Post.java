...
public class Post extends com.dragonflow.SiteView.Action
{
    ...
    public void initializeFromArguments(jgl.Array array, jgl.HashMap hashmap)
    {
        ...
        String s3 = TextUtils.getValue(hashmap, "_proxyusername");
        if(s3.length() > 0)
        {
            setProperty(pProxyUserName, s3);
        }
        String s4 = TextUtils.getValue(hashmap, "_proxypassword");
        if(s4.length() > 0)
        {
        ...
        throws com.dragonflow.SiteViewException.SiteViewException
    {
        ...
        {
            java.util.Vector vector = SiteViewGroup.getTemplateList("templates.post", httprequest);
    ...
    public boolean execute()
    {
        ...
        } else
        {
            ...
            {
                String s9;
                s9 = s9 = Platform.getUsedDirectoryPath("templates.post", monitor.getProperty(com.dragonflow.SiteView.Monitor.pGroupID)) + java.io.File.separator + s4;
            ...
            if(s.length() == 0)
            {
                ...
                j = (int)al[1];
                k = (int)al[2];
                flag = i == Monitor.kURLok;
                s1 = Monitor.lookupStatus(i);
                s = s1 + ", " + s2;
            }
        }
        String s5 = "";
