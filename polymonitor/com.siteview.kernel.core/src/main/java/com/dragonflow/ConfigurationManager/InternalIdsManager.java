...
public class InternalIdsManager {
    ...
    public InternalIdsManager() {
        ...
        settingsFilePath = Platform.getRoot() + java.io.File.separator + "cache" + java.io.File.separator + "persistent" + java.io.File.separator + "ConfigurationManager" + java.io.File.separator + "internalIdsManager";
