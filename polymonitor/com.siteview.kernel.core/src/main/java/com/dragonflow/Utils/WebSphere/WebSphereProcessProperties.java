...
public class WebSphereProcessProperties {
    ...
    static {
        ...
        propsFilename = Platform.getRoot() + java.io.File.separator + "templates.applications" + java.io.File.separator + "websphere.props";
        ...
        if (TextUtils.getValue(hashmap, "_webSphereDebug").length() > 0) {
            enableDebugPrintouts = true;
        }
        String s = TextUtils.getValue(hashmap, "_webSphereServiceHeartBeatFrequency");
        if (s.length() > 0) {
            try {
