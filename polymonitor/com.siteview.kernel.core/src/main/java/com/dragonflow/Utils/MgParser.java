...
public class MgParser
{
    ...
    public static void main(String args[])
    {
        ...
        for(Enumeration enumeration = hashmap.keys(); enumeration.hasMoreElements(); System.out.println())
        {
            String s = (String)enumeration.nextElement();
            System.out.print("   " + s + ": " + TextUtils.getValue(hashmap, s) + " monitor");
    ...
    public java.lang.Object[] getUsageStatistics(boolean flag, boolean flag1, boolean flag2)
    {
        ...
        for(int i1 = 0; i1 < vector.size(); i1++)
        {
            ...
            while (arrayiterator.hasMoreElements())
                ...
                String s = "";
                s = TextUtils.getValue(hashmap2, "_class");
    ...
    private int _countPointsInUse(jgl.HashMap hashmap)
    {
        ...
        String s = TextUtils.getValue(hashmap, "_class");
    ...
    private int _countURLListMonitor(jgl.HashMap hashmap)
    {
        ...
        try
        {
            StringBuffer stringbuffer = com.dragonflow.Utils.MgParser.readFile(TextUtils.getValue(hashmap, "_filename").toString());
        ...
        {
            System.out.println("Couldn't read URL List file " + TextUtils.getValue(hashmap, "_filename"));
        }
        return i;
    }
    ...
    private int _countURLSequenceMonitor(jgl.HashMap hashmap)
    {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if(s1.indexOf("_reference") > -1 && s1.indexOf("_referenceType") == -1 && !TextUtils.getValue(hashmap, s1).toString().equals(""))
            {
                i++;
            }
        }
    ...
    {
        java.lang.Integer integer = new Integer(TextUtils.getValue(hashmap, s).toString());
