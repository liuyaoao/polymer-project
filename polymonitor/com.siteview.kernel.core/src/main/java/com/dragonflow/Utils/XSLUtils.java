...
public class XSLUtils
{
    ...
    {
        int i = Monitor.kURLContentMatchError;
        try
        {
...
//                    } 
        ...
        {
            s13 = "missing " + s;
            i = Monitor.kXMLElementNotFoundError;
        } else
        if(s2 != null)
        {
            if(k1 == 0)
            {
                i = Monitor.kXMLElementMatchError;
