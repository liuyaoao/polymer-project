...
public class BrowsableMIB {
    ...
    public String getXML(com.dragonflow.Utils.Snmp.SNMPSession snmpsession, String s, StringBuffer stringbuffer,com.netaphor.snmp.VariableBinding[] avariablebinding) {
...
//        com.netaphor.snmp.VariableBinding avariablebinding[] = snmpsession.getColumn("1");
        if (avariablebinding == null || avariablebinding.length <= 0) 
        	avariablebinding = snmpsession.getColumn("1");
        ...
        for (int i = 0; i < avariablebinding.length; i ++) {
            ...
            if (!flag && mibnode.getMIB() != mib) {
                continue;//iso.0.8802.1.1.1.1.1.2.1.4
            }
    ...
    static {
        ...
        MIBPath = Platform.getRoot() + java.io.File.separator + "templates.mib";
    }
}
