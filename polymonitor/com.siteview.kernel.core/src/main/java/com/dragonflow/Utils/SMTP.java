...
public class SMTP
{
        ...
        throws java.io.IOException
    {
        ...
        String s = null;
        String s1 = TextUtils.getValue(hashmap, "_httpCharSet");
        ...
        String s2 = TextUtils.getValue(hashmap, "_mailCharSet");
        ...
        String s3 = TextUtils.getValue(hashmap, "_mailSubjectCharSet");
    ...
    String encodeSubject(String s)
    {
        ...
        {
            jgl.HashMap hashmap = MasterConfig.getMasterConfig();
            String s2 = TextUtils.getValue(hashmap, "_mailSubjectCharSet");
            if(s2 == null || s2.equals(""))
            {
                s2 = com.dragonflow.Utils.I18N.isI18N ? "UTF-8" : com.dragonflow.Utils.I18N.getDefaultEncoding();
            }
            String s3 = TextUtils.getValue(hashmap, "_mailjavaCharSet");
        ...
        throws java.lang.Exception
    {
        ...
        for(Enumeration enumeration = array.elements(); enumeration.hasMoreElements(); System.out.println(enumeration.nextElement())) { }
    }
