...
public class LinkFinder
{
    ...
    void findLinks(com.dragonflow.Utils.URLInfo urlinfo, boolean flag)
    {
        ...
        } else
        {
            ...
            {
                urlinfo.duration = Platform.timeMillis() - l;
            }
        }
        urlinfo.size = al[2];
        ...
        if(urlinfo.status == 200 && urlinfo.contentType.equals("text/html") && (!urlinfo.externalLink || flag))
        {
            ...
            if(enumeration.hasMoreElements())
            {
                ...
                s6 = TextUtils.getValue(hashmap, "href");
            }
            if(debugLinkFinder > 0)
            {
            ...
            if(enumeration.hasMoreElements())
            {
                ...
                String s7 = TextUtils.getValue(hashmap1, "background");
                if(s7.length() > 0)
                {
            ...
            while (enumeration.hasMoreElements())
                ...
                String s8 = TextUtils.getValue(hashmap2, "http-equiv").toLowerCase();
                if(s8.equals("refresh"))
                {
                    String s15 = TextUtils.getValue(hashmap2, "content");
            ...
            while(enumeration.hasMoreElements())
                ...
                String s9 = TextUtils.getValue(hashmap3, "src");
                if(s9.length() > 0)
                {
            ...
            while (enumeration.hasMoreElements())
                ...
                if(TextUtils.getValue(hashmap4, "type").equals("image"))
                {
                    String s10 = TextUtils.getValue(hashmap4, "src");
                    if(s10.length() > 0)
                    {
            ...
            while (enumeration.hasMoreElements())
                ...
                String s11 = TextUtils.getValue(hashmap5, "href");
                if(s11.length() > 0)
                {
            ...
            while (enumeration.hasMoreElements())
                ...
                String s12 = TextUtils.getValue(hashmap6, "src");
                if(s12.length() > 0)
                {
            ...
            while (enumeration.hasMoreElements())
                ...
                String s13 = TextUtils.getValue(hashmap7, "src");
                if(s13.length() > 0)
                {
            ...
            while (enumeration.hasMoreElements())
                ...
                String s14 = TextUtils.getValue(hashmap8, "href");
                if(s14.length() > 0)
                {
