    ...
    implements jgl.BinaryPredicate
{
    ...
    public jgl.HashMap FindVariable(jgl.Array array, String s)
    {
        ...
        for(Enumeration enumeration = array.elements(); enumeration.hasMoreElements();)
        {
            ...
            String s1 = TextUtils.getValue(hashmap, "_value");
            if(s1.startsWith(s))
            {
                return hashmap;
            }
    ...
    public jgl.Array getVariables(jgl.Array array, String s, String s1)
    {
        ...
        jgl.HashMap hashmap;
        for(Enumeration enumeration = array1.elements(); enumeration.hasMoreElements(); array2.add(TextUtils.getValue(hashmap, "_value")))
        {
    ...
    private jgl.Array getFormInputs(jgl.Array array, String s, String s1)
    {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            String s2 = TextUtils.getValue(hashmap1, "type").toLowerCase();
            if(s2.length() == 0)
            {
                s2 = "text";
            }
            ...
            {
                AddValue(array1, hashmap1, TextUtils.getValue(hashmap1, "name"), TextUtils.getValue(hashmap1, "value"));
            } else
            if(s2.equals("radio"))
            {
                String s4 = TextUtils.getValue(hashmap1, "name");
            ...
            if(s2.equals("submit"))
            {
                if(hashmap1.get("name") != null)
                {
                    ...
                    if(TextUtils.getValue(hashmap1, "name").equals(s) && TextUtils.getValue(hashmap1, "value").equals(s1))
                    {
            ...
            if(s2.equals("image"))
            {
                ...
                if(hashmap1.get("name") != null)
                {
                    if(s == null)
                    {
                        AddValue(array1, hashmap1, TextUtils.getValue(hashmap1, "name") + ".x", "1");
                        AddValue(array1, hashmap2, TextUtils.getValue(hashmap2, "name") + ".y", "1");
                    } else
                    if(TextUtils.getValue(hashmap1, "name").equals(s))
                    {
        ...
        while (enumeration1.hasMoreElements()) {
            ...
            {
                AddValue(array1, hashmap3, s3, TextUtils.getValue(hashmap3, "value"));
            }
        }
        jgl.HashMap hashmap4;
        for(Enumeration enumeration2 = findTags(array, "textarea"); enumeration2.hasMoreElements(); AddValue(array1, hashmap4, TextUtils.getValue(hashmap4, "name"), TextUtils.getValue(hashmap4, "contents")))
        {
        ...
        while (enumeration3.hasMoreElements()) {
            ...
            String s5 = TextUtils.getValue(hashmap5, "name");
            ...
            while (enumeration4.hasMoreElements()) {
                ...
                if(hashmap7.get("selected") != null)
                {
                    ...
                    {
                        String s7 = "value";
                        if(TextUtils.getValue(hashmap7, s7).length() == 0)
                        {
                            s7 = "contents";
                        }
                        AddValue(array1, hashmap7, s5, TextUtils.getValue(hashmap7, s7));
                    } else
                    {
                        hashmap6 = hashmap7;
                    }
            ...
            {
                String s6 = "value";
                if(TextUtils.getValue(hashmap6, s6).length() == 0)
                {
                    s6 = "contents";
                }
                AddValue(array1, hashmap6, s5, TextUtils.getValue(hashmap6, s6));
            }
        } 
    ...
    public boolean execute(java.lang.Object obj, java.lang.Object obj1)
    {
        ...
        return com.dragonflow.Utils.TextUtils.toInt(TextUtils.getValue(hashmap, "_order")) < com.dragonflow.Utils.TextUtils.toInt(TextUtils.getValue(hashmap1, "_order"));
    }
