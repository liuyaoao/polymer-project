...
public class HTTPUtils {
    ...
    public static int getDisplayOrder(String s) {
        ...
        int i = com.dragonflow.Utils.TextUtils.toInt(TextUtils.getValue(hashmap, "_URLLocationComponent"));
        if (i <= 0) {
            i = 6;
        }
    ...
    public static String getLocationPart(String s, int i) {
        jgl.HashMap hashmap = MasterConfig.getMasterConfig();
        int j = com.dragonflow.Utils.TextUtils.toInt(TextUtils.getValue(hashmap, "_URLLocationComponent"));
        if (j <= 0) {
            j = 6;
        }
