...
public class MailUtils {
    ...
    public static String mail(jgl.HashMap hashmap, String s, String s1, String s2, String s3, jgl.Array array, boolean flag, String s4, String s5) {
        ...
        String s8 = com.dragonflow.Utils.MailUtils.mail1(hashmap, s6, s, s1, s2, s3, array, flag, s4, s5);
        if (s8.length() != 0) {
    ...
    static String mail1(jgl.HashMap hashmap, String s, String s1, String s2, String s3, String s4, jgl.Array array, boolean flag, String s5, String s6) {
        ...
        String s10 = com.dragonflow.Utils.LUtils.getLicenseSummary(hashmap, true);
        if (s10.length() == 0) {
            s10 = Platform.productName + " from " + com.dragonflow.SiteView.Platform.companyName;
        }
        ...
        try {
            ...
            s13 = Monitor.lookupStatus(com.dragonflow.SiteView.Monitor.kURLBadHostNameError);
        } catch (java.net.SocketException socketexception) {
            if (com.dragonflow.SiteView.Platform.noRoute(socketexception)) {
                s13 = Monitor.lookupStatus(com.dragonflow.SiteView.Monitor.kURLNoRouteToHostError);
            } else {
                s13 = Monitor.lookupStatus(com.dragonflow.SiteView.Monitor.kURLNoConnectionError);
            }
        } catch (java.io.InterruptedIOException interruptedioexception) {
            s13 = Monitor.lookupStatus(com.dragonflow.SiteView.Monitor.kURLTimeoutError);
