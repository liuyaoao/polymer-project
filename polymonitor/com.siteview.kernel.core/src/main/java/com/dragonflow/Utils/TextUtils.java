...
public class TextUtils
{
        ...
        if(!customPrettyDatePatternInitialized)
        {
            synchronized(prettyDateSync)
            {
                if(!customPrettyDatePatternInitialized)
                {
                    ...
                    String s = TextUtils.getValue(MasterConfig.getMasterConfig(), "_prettyDateCustomPattern");
                    if(s.length() > 0)
                    {
                        try
                        {
    ...
    {
        return com.dragonflow.Utils.TextUtils.matchExpression(s, s1) == Monitor.kURLok;
    }
    ...
    public static int matchExpression(String s, String s1, jgl.Array array, COM.oroinc.text.perl.Perl5Util perl5util)
    {
        int i;
        boolean flag;
        i = Monitor.kURLContentMatchError;
    ...
    {
        String s1 = (String)MasterConfig.getMasterConfig().get(s);
