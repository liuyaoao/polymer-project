...
public class JMXInterface {
    ...
    public JMXInterface() {
        ...
        try {
            ...
            attrMethod = QueryClass.getMethod("attr", new java.lang.Class[] { String.class });
            valueMethod = QueryClass.getMethod("value", new java.lang.Class[] { String.class });
            queryNamesMethod = MBeanServerClass.getMethod("queryNames", new java.lang.Class[] { ObjectNameClass, QueryExpClass });
            getAttributeMethod = MBeanServerClass.getMethod("getAttribute", new java.lang.Class[] { ObjectNameClass, String.class });
            getMBeanInfoMethod = MBeanServerClass.getMethod("getMBeanInfo", new java.lang.Class[] { ObjectNameClass });
            invokeMethod = MBeanServerClass.getMethod("invoke", new java.lang.Class[] { ObjectNameClass, String.class, java.lang.Object[].class, String[].class });
            objectNameCtr = ObjectNameClass.getConstructor(new java.lang.Class[] { String.class });
            equalsMethod = ObjectNameClass.getMethod("equals", new java.lang.Class[] { java.lang.Object.class });
            getKeyPropertyMethod = ObjectNameClass.getMethod("getKeyProperty", new java.lang.Class[] { String.class });
