...
public class HTTPRequestSettings {
    ...
    public HTTPRequestSettings(String s, String s1, String s2, String s3, java.lang.Boolean boolean1, String s4, String s5, String s6, java.util.Vector vector, int i, int j, int k) {
        url = null;
        host = "";
        port = 0;
        scheme = null;
    ...
    public String getCertFilename() {
        if (certFilename == null) {
            ...
            String s = TextUtils.getValue(hashmap, "_urlClientCert").trim();
            if (s.length() > 0) {
                certFilename = Platform.getRoot() + java.io.File.separator + "templates.certificates" + java.io.File.separator + s;
            } else {
                certFilename = "";
            }
        }
    ...
    public String getCertPassword() {
        if (certPassword == null) {
            jgl.HashMap hashmap = MasterConfig.getMasterConfig();
            certPassword = TextUtils.getValue(hashmap, "_urlClientCertPassword").trim();
        }
    ...
    public java.lang.Boolean getAcceptAllUntrustedCerts() {
        if (acceptAllUntrustedCerts == null) {
            jgl.HashMap hashmap = MasterConfig.getMasterConfig();
            acceptAllUntrustedCerts = new Boolean(TextUtils.getValue(hashmap, "_sslAcceptAllUntrustedCerts").trim().equalsIgnoreCase("true"));
        }
    ...
    public java.lang.Boolean getAcceptInvalidCerts() {
        if (acceptInvalidCerts == null) {
            jgl.HashMap hashmap = MasterConfig.getMasterConfig();
            acceptInvalidCerts = new Boolean(TextUtils.getValue(hashmap, "_sslAcceptInvalidCerts").trim().equalsIgnoreCase("true"));
        }
