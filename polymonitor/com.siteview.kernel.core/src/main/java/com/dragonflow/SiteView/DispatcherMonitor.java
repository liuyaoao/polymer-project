...
public class DispatcherMonitor extends AtomicMonitor {
    ...
    static String getConnectionParamStr(HashMap hashmap) {
        Object obj = null;
        String s = "";
        if (hashmap != null) {
     ...
     * @return
     */
    static String getCounterParamStr(HashMap hashmap) {
        Object obj = null;
        String s = "";
        if (hashmap != null) {
    ...
    static String dispatcherRequest(DispatcherConnection dispatcherconnection,
        ...
        String s5 = getCounterParamStr(hashmap1);
    ...
    public static void notifyDispatcherMonitor(String s,
    ...
    public static void killDispatcher() {
