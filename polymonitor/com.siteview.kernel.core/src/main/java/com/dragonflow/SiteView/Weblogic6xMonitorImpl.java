/*
 * 
 * Created on 2014-2-16 17:37:14
 *
 * Weblogic6xMonitorImpl.java
 *
 * History:
 *
 */
...
/**
 * Comment for <code>Weblogic6xMonitorImpl</code>
 * 
 * @author
 * @version 0.0
 * 
...
public class Weblogic6xMonitorImpl {
    ...
    public String update(String as[], String as1[], String as2[]) {
        ...
        for (int i = 0; i < as1.length; i ++) {
            ...
            LogManager.log("Error", "Failed to get value for counter " + as1[i] + ". If this happens only a handfull of counters, it is probably due to a WebLogic bug");
                        ...
                        if (s3.regionMatches(0, result, 0, i)) {
                            ...
                            try {
                                ...
                                if (obj3 != null) {
                                    ...
                                    LogManager.log("RunMonitor", "Ambiguous near macth found:\n   " + obj3 + "\n" + "   " + obj4);
                                    return null;
                                }
                                obj3 = obj4;
                            }
    ...
    public String getBrowseData(StringBuffer stringbuffer) {
        try {
            ...
            if (s == null) {
                stringbuffer.append("Unable to load the list of counters. Please check if you are using the correct version of the WebLogic jar file.");
            } else {
