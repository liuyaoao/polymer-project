...
public class DispatcherSitter extends Thread {
    ...
    private static String dispDirectory = Platform.getRoot();
    ...
    static {
        configPath = Platform.getRoot() + File.separator + "groups"
                + File.separator + "dispatcher.config";
        dispatcherPortPath = Platform.getRoot() + File.separator + "dat"
                + File.separator + "tss_port";
        dispatcherClientPath = Platform.getRoot() + File.separator + "dat"
                + File.separator + "tss_mons";
        dispatcherWinStartPath = Platform.getRoot() + File.separator + "bin"
                + File.separator + "disp_start.bat";
        dispatcherUnixStartPath = Platform.getRoot() + File.separator + "bin"
                + File.separator + "disp_start.sh";
        dispBinDirectory = Platform.getRoot() + File.separator + "bin"
                + File.separator;
    }
}
