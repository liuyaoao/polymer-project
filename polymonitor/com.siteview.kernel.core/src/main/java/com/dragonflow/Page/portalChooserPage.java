...
public class portalChooserPage extends com.dragonflow.Page.CGI
{
    ...
    private static void printQueryChooser(java.io.PrintWriter printwriter, com.dragonflow.HTTP.HTTPRequest httprequest, String s, String s1, String s2, boolean flag)
    {
        ...
        if(flag)
        {
            jgl.Array array = Portal.getEditableQueryArray();
        ...
        throws java.lang.Exception
    {
        ...
        String s1 = Platform.getDirectoryPath("groups", s);
        ...
        for(int i = 0; i < array.size(); i++)
        {
            ...
            if(!TextUtils.getValue(hashmap1, "_user").equals(s))
            {
                continue;
            }
            hashmap = hashmap1;
        ...
        if(flag1)
        {
            ...
            do
            {
                ...
                if(s7.startsWith(OPEN_VARIABLE))
                {
                    ...
                    if(!TextUtils.getValue(hashmap, s10).equals("open"))
                    {
                ...
                if(s7.startsWith(CLOSE_VARIABLE))
                {
                    ...
                    if(!TextUtils.getValue(hashmap, s11).equals("close"))
                    {
                        hashmap.remove(s11);
                        flag = true;
                    }
        ...
        if(enumeration2.hasMoreElements())
        {
            ...
            if(com.dragonflow.SiteView.Platform.isPortal())
            {
                obj = Portal.getPortal();
            } else
            {
                obj = SiteViewGroup.currentSiteView();
            }
            do
            {
