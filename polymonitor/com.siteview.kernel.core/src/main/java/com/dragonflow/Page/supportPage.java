...
public class supportPage extends com.dragonflow.Page.CGI
{
    ...
    void printSentMail()
    {
        ...
        String s6 = Platform.productName + " Support Request from " + s1 + " [attachments]" + s5;
        ...
        {
            String s7 = Platform.getRoot() + "/groups/";
        ...
        {
            String s9 = Platform.getRoot() + "/logs/";
        ...
        {
            String s10 = Platform.getRoot() + "/logs/";
        ...
        {
            String s11 = Platform.getRoot() + "/logs/";
        ...
        {
            String s12 = Platform.getRoot() + "/logs/";
        ...
        {
            String s13 = Platform.getRoot() + "/logs/";
            long l = Platform.makeDate().getTime() - (long)(com.dragonflow.Utils.TextUtils.DAY_SECONDS * 1000);
