...
public class servicePage extends com.dragonflow.Page.machineChooserPage
{
    ...
    public static jgl.HashMap getProcessStats(String s, String s1)
    {
        ...
        com.dragonflow.SiteView.Machine machine = Machine.getNTMachine(s2);
        ...
        do
        {
            ...
            String s5 = TextUtils.getValue(hashmap2, "parent");
    ...
    public static void printProcessStats(int i, java.io.PrintWriter printwriter, StringBuffer stringbuffer, String s, boolean flag)
    {
        ...
        String s1 = Platform.psCommand(s, flag);
        ...
        } else
        {
            ...
            try
            {
                long al1[] = Platform.cpuUsed(s, 0L, 0L, al);
                if(al1 != null)
                {
                    l = al1[3];
                }
            ...
            do
            {
                ...
                if(!s3.equals("Idle"))
                {
                    ...
                    if(stringbuffer != null)
                    {
                        com.dragonflow.Utils.TextUtils.appendStringLeftJustify(stringbuffer, TextUtils.getValue(hashmap2, "name"), 20);
                        com.dragonflow.Utils.TextUtils.appendStringLeftJustify(stringbuffer, "" + s4, 9);
                        com.dragonflow.Utils.TextUtils.appendStringLeftJustify(stringbuffer, TextUtils.getValue(hashmap2, "memory"), 12);
                        com.dragonflow.Utils.TextUtils.appendStringLeftJustify(stringbuffer, TextUtils.getValue(hashmap2, "threads"), 9);
                        com.dragonflow.Utils.TextUtils.appendStringLeftJustify(stringbuffer, TextUtils.getValue(hashmap2, "handles"), 9);
                        com.dragonflow.Utils.TextUtils.appendStringLeftJustify(stringbuffer, TextUtils.getValue(hashmap2, "id"), 9);
                        com.dragonflow.Utils.TextUtils.appendStringLeftJustify(stringbuffer, TextUtils.getValue(hashmap2, "parent"), 20);
                        stringbuffer.append("\n");
                    }
                }
            } while(true);
