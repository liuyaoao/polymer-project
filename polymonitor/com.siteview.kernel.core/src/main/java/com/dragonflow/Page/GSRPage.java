...
public class GSRPage extends com.dragonflow.Page.CGI {
                                        ...
                                        if(s.equals("EXPORT RUNBOOK"))
                                        {
                                            if(request.getValue("newform") != null && request.getValue("newform").equals("SUBMIT"))
                                            {
                                                ...
                                                } else
                                                {
                                                    ...
                                                    jgl.HashMap hashmap14 = MasterConfig.getMasterConfig();
    ...
    private String printGroup(com.dragonflow.SiteView.MonitorGroup monitorgroup, jgl.HashMap hashmap, jgl.HashMap hashmap1, int i, boolean flag, String s)
    {
        ...
        if(!flag1)
        {
            ...
            outputStream.print("<input type=checkbox name=group value=\"" + s1 + "\" " + TextUtils.getValue(hashmap1, s1) + "><B>");
        ...
        do
        {
            ...
            } else
            {
                ...
                if(!flag1 && flag2)
                {
                    outputStream.print("<TR><TD>");
                    outputStream.print(s3);
                    outputStream.print("<input type=checkbox name=monitor value=\"" + s6 + "\" " + TextUtils.getValue(hashmap1, s6) + ">");
    ...
    throws java.lang.Exception
    {
        ...
        String s8 = Platform.getDirectoryPath("groups", request.getAccount());
        ...
        for(int i = 0; i < array.size(); i++)
        {
            ...
            if(TextUtils.getValue(hashmap1, "_user").equals(s10))
            {
                hashmap = hashmap1;
            }
        }
        ...
        do
        {
            ...
            if(s11.startsWith(OPEN_VARIABLE))
            {
                ...
                if(!TextUtils.getValue(hashmap, s12).equals("open"))
                {
            ...
            if(s11.startsWith(CLOSE_VARIABLE))
            {
                ...
                if(!TextUtils.getValue(hashmap, s13).equals("close"))
                {
                    hashmap.remove(s13);
                    flag = true;
                }
    ...
    public void createCustomEdit(String s, String s1, String s2, String s3)
    {
        ...
        try
        {
            jgl.HashMap hashmap2 = (jgl.HashMap)MasterConfig.getMasterConfig().clone();
    ...
    public String createXML()
    {
        ...
        s2 = s2 + "</GSR>\n";
        String s7 = Platform.getRoot() + "/templates.view/runbook/runbook.xml";
        try
        {
    ...
    {
        String s1 = Platform.getRoot() + "/templates.view/runbook/runbook.xml";
