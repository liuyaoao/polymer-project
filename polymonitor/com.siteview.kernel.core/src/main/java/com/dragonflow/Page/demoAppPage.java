...
public class demoAppPage extends com.dragonflow.Page.CGI
{
    ...
    public void integratePages(String s, String s1)
    {
        ...
        String s2 = TextUtils.getValue(hashmap, "_appServer");
        ...
        String s4 = s2 + "/SiteView/cgi/go.exe/SiteView?page=demoApp&session=" + s3 + "&" + s1;
        ...
        throws java.lang.Exception
    {
        ...
        for(int i = 0; i < array.size(); i++)
        {
            ...
            outputStream.println("<TR><TD><A HREF=" + s + TextUtils.getValue(hashmap, "id") + "><B>" + TextUtils.getValue(hashmap, "name") + "</B></A></TD>" + "<TD>" + TextUtils.getValue(hashmap, "description") + "</TD>" + "<TD>" + TextUtils.getValue(hashmap, "price") + "</TD></TR>");
        }
        ...
        throws java.lang.Exception
    {
        ...
        do
        {
            ...
            if(TextUtils.getValue(hashmap1, "id").equals(s))
            {
                hashmap = hashmap1;
                break;
            }
        ...
        {
            outputStream.println("<H2>" + TextUtils.getValue(hashmap, "description") + "</H2>");
        ...
        throws java.lang.Exception
    {
        ...
        } else
        {
            ...
            do
            {
                ...
                if(hashmap2 != null)
                {
                    outputStream.println("<TR><TD><A HREF=" + s1 + TextUtils.getValue(hashmap2, "id") + ">" + TextUtils.getValue(hashmap2, "name") + "</A>" + "</TD><TD>" + TextUtils.getValue(hashmap2, "description") + "</TD></TR>");
                }
            } while(true);
            outputStream.println("</TABLE>");
        ...
        throws java.lang.Exception
    {
        ...
        } else
        {
            ...
            do
            {
                ...
                if(hashmap1 != null)
                {
                    outputStream.println("<TR><TD><A HREF=" + s1 + TextUtils.getValue(hashmap1, "id") + ">" + TextUtils.getValue(hashmap1, "name") + "</A>" + "</TD><TD>" + TextUtils.getValue(hashmap1, "description") + "</TD></TR>");
                }
            } while(true);
            outputStream.println("</TABLE>");
        ...
        throws java.lang.Exception
    {
        ...
        } else
        {
            ...
            String s1 = "" + l;
            String s2 = "Your order number was " + s1;
    ...
    jgl.HashMap findFrame(jgl.Array array, String s, String s1)
    {
        ...
        {
            jgl.HashMap hashmap = (jgl.HashMap)array.at(i);
            if(TextUtils.getValue(hashmap, s).equals(s1))
            {
                return hashmap;
            }
        }
