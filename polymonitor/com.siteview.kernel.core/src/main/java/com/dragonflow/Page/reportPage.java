...
label1:
    ...
    String scheduleFilterHTML(String s)
    {
        ...
        jgl.HashMap hashmap;
        for(Enumeration enumeration = com.dragonflow.Page.CGI.getValues(getSettings(), "_additionalSchedule"); enumeration.hasMoreElements(); vector.addElement(TextUtils.getValue(hashmap, "_name")))
        {
...
label1:
    ...
    public static String getDefaultReportTitle(jgl.HashMap hashmap)
    {
        ...
        if(j == 0 && i == 0)
        {
            if(TextUtils.getValue(hashmap, "showAlertsOnly").length() == 0)
            {
                ...
                {
                    com.dragonflow.SiteView.PortalFilter portalfilter = new PortalFilter(TextUtils.getValue(hashmap, "query"));
    ...
    public static jgl.Array getReportFrames(String s)
    {
        ...
        try
        {
            ...
            {
                String s1 = Platform.getRoot() + java.io.File.separator + "groups" + java.io.File.separator + "history.config";
