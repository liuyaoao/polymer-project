...
label0:
    ...
    void printOrdering(Monitor monitor, jgl.Array array)
    {
        ...
        for(int l = 1; l < array.size(); l++)
        {
            ...
            outputStream.println("<OPTION value=" + l + " " + s1 + "> before " + TextUtils.getValue(hashmap1, "_name") + "</OPTION>");
        }
...
//                    }
    ...
    void printAddListForm(String s, String s1, String s2)
    {
        ...
        try
        {
            array = com.dragonflow.Page.monitorPage.getMonitorClasses(this, true);/*�޸�ΪTrue*/
        }
        catch(java.lang.Exception exception)
        {
            System.out.println("*** " + exception);
