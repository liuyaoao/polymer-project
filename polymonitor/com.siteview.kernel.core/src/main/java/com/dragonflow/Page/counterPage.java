        ...
        throws java.lang.Exception
    {
        ...
        } else
        {
            ...
            if(s13.equals("NTCounter"))
            {
                ...
                array = NTCounterBase.getPerfCounters(s11, array1, stringbuffer, "");
                outputStream.print("<input type=hidden name=\"counterobjects\" value=\"" + s20 + "\">");
            }
            if(s13.equals("SNMP"))
            {
                array = new Array();
                String s21 = SNMPBase.getTemplateContent(com.dragonflow.SiteView.SNMPBase.getTemplatePath(), request.getValue("filename"), true);
            ...
            {
                array = new Array();
                String s22 = URLContentBase.getTemplateContent(com.dragonflow.SiteView.URLContentBase.getTemplatePath(), request.getValue("filename"), true);
            ...
            if(s13.equals("MultiContentBase"))
            {
                ...
                array = new Array();
                String s23 = MultiContentBase.getTemplateContent(com.dragonflow.SiteView.MultiContentBase.getTemplatePath(), request.getValue("filename"), true);
            ...
            for(Enumeration enumeration = request.getVariables(); enumeration.hasMoreElements();)
            {
