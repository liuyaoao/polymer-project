...
//    public static final String TOPAZ_LOGGING_OP = TopazInfo.getTopazNameShort() + " Logging Options";
    ...
    String[] getReplaces()
    {
        ...
        if(s.length() > 0)
        {
            ...
            as[0] = s;
            as[1] = s1;
            com.dragonflow.SiteView.Machine machine = Machine.getMachineByName(s);
            if(machine != null)
            {
                com.dragonflow.SiteView.Machine machine1 = Machine.getMachineByName(s1);
                if(machine1 != null)
                {
                    as = new String[6];
                    as[0] = s;
                    as[1] = Machine.REMOTE_PREFIX + machine.getProperty(com.dragonflow.SiteView.Machine.pID);
                    as[2] = machine.getProperty(com.dragonflow.SiteView.Machine.pHost);
                    as[3] = s1;
                    as[4] = Machine.REMOTE_PREFIX + machine1.getProperty(com.dragonflow.SiteView.Machine.pID);
...
label1:
        ...
        if(s.startsWith("Disable"))
        {
            ...
            s19 = TextUtils.getValue(hashmap1, "_defaultDisableTime");
        ...
        if(s.startsWith("Acknowledge"))
        {
            ...
            s21 = TextUtils.getValue(hashmap2, "_defaultDisableAlertTime");
            ...
            String s36 = TextUtils.getValue(hashmap2, "_defaultDisableTime");
            if(s36.equals(""))
            {
                s36 = "60";
            }
            ...
            String s40 = Platform.getDirectoryPath("logs", request.getAccount());
...
//            } else
        ...
        if(flag6)
        {
            ...
            String s27 = TextUtils.getValue(hashmap3, "_defaultDisableTime");
            if(s27.equals(""))
            {
                s27 = "60";
            }
    ...
    void completeGroupList(String s, jgl.Array array)
    {
        try
        {
            ...
            while (enumeration.hasMoreElements())
                ...
                {
                    String s2 = com.dragonflow.Utils.I18N.toDefaultEncoding(TextUtils.getValue(hashmap, "_group"));
                    if(s2.length() != 0)
                    {
                        array.add(s2);
...
//                    stringbuffer.append("<option value=" + s5 + s2 + ">" + s4 + "</option>\n");
                    stringbuffer.append("<paper-item value=" + s5 + s2 + ">" + s4 + "</paper-item>\n");
                }
            }
        }
        catch(java.lang.Exception exception)
...
//        stringbuffer.append("<td align=\"left\"valign=\"top\"><input type=submit name=operation VALUE=\"Apply Filter\"></td></tr></table></FORM>");
        ...
        stringbuffer.append("</filter-setting-form>");
...
//            } else
    ...
    private jgl.Array getFilteredGroupList()
    {
        ...
        Enumeration enumeration = SiteViewGroup.cCurrentSiteView.getMonitors();
        do
        {
            if(!enumeration.hasMoreElements())
            {
...
//                }
        ...
        throws java.lang.Exception
    {
        ...
        for(int i = 0; i < array.size(); i++)
        {
            ...
            String s4 = com.dragonflow.Utils.I18N.toDefaultEncoding(TextUtils.getValue(hashmap1, "_parent"));
...
//                continue;
//            }
            jgl.HashMap hashmap4 = MasterConfig.getMasterConfig();
//            if(TextUtils.getValue(hashmap4, "_topazGroupMoveHardSync").length() > 0)
//            {
...
//            com.dragonflow.SiteView.TopazConfigurator.moveGroupInTopaz(s1, s);
    ...
    private boolean overRemoteMonitorsLimit(String s, jgl.Array array)
    {
        ...
        String s3 = monitorUtils.getPermission(hashmap1, "_monitorType", "URLRemoteMonitor");
        int i1;
        ...
        String s4 = monitorUtils.getPermission(hashmap1, "_monitorType", "URLRemoteSequenceMonitor");
        int j1;
        ...
        String s5 = TextUtils.getValue(hashmap1, "_maximumFAndIMonitors");
        ...
        throws java.lang.Exception
    {
        ...
        for(int i = 1; i < array.size(); i++)
        {
            ...
            {
                String s1 = com.dragonflow.Utils.I18N.toDefaultEncoding(TextUtils.getValue(hashmap2, "_group"));
                ...
                try
                {
                    ...
                    if(array2.size() > 0)
                    {
                        ...
                        String s2 = TextUtils.getValue(hashmap3, "_name");
                        if(s2 != null && s2.length() > 0 && s2.equalsIgnoreCase("config"))
                        {
                            hashmap3.put("_name", TextUtils.getValue(hashmap2, "_name"));
                        }
                    }
                }
                catch(java.lang.Exception exception)
        ...
        throws java.lang.Exception
    {
        ...
        if(com.dragonflow.SiteView.Platform.isStandardAccount(request.getAccount()))
        {
            s = Platform.getDirectoryPath("groups", request.getAccount());
        } else
        {
            s = Platform.getRoot() + java.io.File.separator + "accounts" + java.io.File.separator + request.getAccount();
        }
        ...
        } else
        {
            ...
            for(int i = 0; i < array.size(); i++)
            {
                ...
                if(TextUtils.getValue(hashmap1, "_user").equals(account))
                {
                    hashmap = hashmap1;
                }
            }
            ...
            do
            {
                ...
                if(s4.startsWith(OPEN_VARIABLE))
                {
                    ...
                    if(!TextUtils.getValue(hashmap, s5).equals("open"))
                    {
                        hashmap.put(s5, "open");
                        flag = true;
                    }
                ...
                if(s4.startsWith(CLOSE_VARIABLE))
                {
                    ...
                    if(!TextUtils.getValue(hashmap, s6).equals("close"))
                    {
                        hashmap.remove(s6);
                        flag = true;
                    }
...
//        outputStream.println("</FORM>");
        outputStream.println("</filter-list-form>");
        printFooter(outputStream);
        if(flag)
        {
            if(debug)
...
//                outputStream.print("<tr><td><input type=checkbox name=monitor value=\"" + s2 + "\"+ CHECKED></td>");
        ...
        {
            outputStream.print("<table class='filter-tree' border=\"0\" cellspacing=\"0\" cellpadding=\"5\" width=\"90%\">");
...
label2:
        ...
        for(int j1 = 0; j1 < array2.size(); j1++)
        {
            ...
            String s6 = Monitor.pBaselineMean.getName();
            com.dragonflow.SiteView.Monitor _tmp1 = monitor2;
            String s7 = Monitor.pBaselineStdDev.getName();
            com.dragonflow.SiteView.Monitor _tmp2 = monitor2;
            String s8 = Monitor.pBaselineDate.getName();
        ...
        throws java.lang.Exception
    {
        ...
        for(int i = 1; i < array.size(); i++)
        {
            ...
            String s7 = TextUtils.getValue(hashmap, "_class");
            if(s7.equals("SubGroup"))
            {
                String s8 = com.dragonflow.Utils.I18N.toDefaultEncoding(TextUtils.getValue(hashmap, "_group"));
                if(s8.length() != 0)
                {
    ...
    {
        com.dragonflow.SiteView.SiteViewGroup siteviewgroup = SiteViewGroup.currentSiteView();
        String s5 = TextUtils.getValue(hashmap, "_class");
        String s6 = TextUtils.getValue(hashmap, "_id");
        boolean flag = false;
        ...
        if(s2.equals("0"))
        {
            printProgressMessage("Undo schedule for " + TextUtils.getValue(hashmap, "_name") + "<BR>");
        } else
        {
        ...
        throws java.lang.Exception
    {
        ...
        if(infoMonitor != null)
        {
            String s5 = TextUtils.getValue(infoState, "_class");
            if(s5.equals("SubGroup"))
            {
                String s6 = com.dragonflow.Utils.I18N.toDefaultEncoding(TextUtils.getValue(infoState, "_group"));
        ...
        throws java.lang.Exception
    {
        ...
        for(int i = 1; i < array.size(); i++)
        {
            ...
            {
                String s7 = com.dragonflow.Utils.I18N.toDefaultEncoding(TextUtils.getValue(hashmap, "_group"));
                if(s7.length() != 0)
                {
                    acknowledgeGroup(s7, s1, s2, s3, s4, flag);
                }
            }
            String s8 = TextUtils.getValue(hashmap, "_id");
    ...
    {
        com.dragonflow.SiteView.SiteViewObject siteviewobject = Portal.getSiteViewForID(request.getValue("group"));
...
label0:
        ...
        {
            jgl.HashMap hashmap1 = (jgl.HashMap)array.at(i);
            String s1 = TextUtils.getValue(hashmap1, "_class");
            if(s1.equals("SubGroup"))
            {
                String s2 = TextUtils.getValue(hashmap1, "_group");
                if(s2.length() == 0)
                {
                    continue;
                }
            ...
            String s3 = TextUtils.getValue(hashmap1, "_id");
            if(s3.equals(""))
            {
                continue;
            }
