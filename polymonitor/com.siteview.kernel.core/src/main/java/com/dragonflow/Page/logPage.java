...
public class logPage extends com.dragonflow.Page.CGI
{
        ...
        throws java.lang.Exception
    {
        ...
        if(request.actionAllowed("_preference"))
        {
            ...
            menus1.add(new CGI.menuItems("Remote Windows", "windowsmachine", "", "page", "Add/Edit Remote Win NT/2000 profiles"));
        }
        ...
        String s1 = Platform.getURLPath("logs", s);
        String s2 = Platform.getDirectoryPath("logs", s);
        String s3 = Portal.cleanPortalServerID(request.getPortalServer());
        if(s3.length() > 0)
        {
            s1 = "/SiteView/portal/" + s3 + "/logs";
            s2 = Portal.getPortalSiteViewRootPath(s3) + java.io.File.separator + "logs";
        }
        String s4 = "";
        String s8 = "";
        s4 = "";
