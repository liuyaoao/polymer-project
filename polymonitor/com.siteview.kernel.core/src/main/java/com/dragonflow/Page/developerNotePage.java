...
public class developerNotePage extends com.dragonflow.Page.CGI
{
    ...
    private static String NOTE_CACHE_FILENAME = Platform.getRoot() + "/htdocs/developerNoteList.html";
        ...
        throws java.io.IOException
    {
        ...
        if(request.isPost())
        {
            ...
            if(s6.length() == 0)
            {
                ...
                String s9 = TextUtils.getValue(hashmap1, "_developerNoteNextID");
        ...
        throws java.lang.Exception
    {
        ...
        String s = TextUtils.getValue(hashmap, "_developerNoteSourcePath");
        if(s.length() == 0)
        {
