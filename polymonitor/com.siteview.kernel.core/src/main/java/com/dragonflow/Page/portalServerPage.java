...
public class portalServerPage extends com.dragonflow.Page.portalPreferencePage
{
    ...
    {
        String s = TextUtils.getValue(hashmap, "_server");
        String s1 = TextUtils.getValue(hashmap, "_logCollectorRefresh");
        if(s.length() == 0)
        {
        ...
        if(hashmap1.size() == 0 && TextUtils.getValue(hashmap, "_title").length() == 0)
        {
            hashmap.put("_title", s);
        }
        String s2 = TextUtils.getValue(hashmap, "_proxy");
        if(s2.length() > 0)
        {
        ...
        throws java.io.IOException
    {
        ...
        outputStream.println("<TR><TD ALIGN=RIGHT>Server Address</TD><TD><TABLE><TR><TD ALIGN=LEFT><input type=text name=server size=50 value=\"" + com.dragonflow.Page.portalServerPage.getValue(hashmap, "_server") + "\"></TD></TR>" + "<TR><TD><FONT SIZE=-1>the server address and SiteView port of the server (for example, demo." + com.dragonflow.SiteView.Platform.exampleDomain + ":80)</FONT></TD></TR>" + "<TR><TD><FONT SIZE=-1>to communicate with the remote SiteView using https include the protocol specifier in the server address " + "(for example, https://demo." + com.dragonflow.SiteView.Platform.exampleDomain + ":80)</FONT></TD></TR>" + "</TABLE></TD><TD><I>" + TextUtils.getValue(hashmap1, "server") + "</I></TD></TR>");
        outputStream.println("<TR><TD ALIGN=RIGHT>Title</TD><TD><TABLE><TR><TD ALIGN=LEFT><input type=text name=title size=50 value=\"" + com.dragonflow.Page.portalServerPage.getValue(hashmap, "_title") + "\"></TD></TR>" + "<TR><TD><FONT SIZE=-1>optional title for this item in the Multi-View window, the default title is the server address</FONT></TD></TR>" + "</TABLE></TD><TD><I>" + TextUtils.getValue(hashmap1, "title") + "</I></TD></TR>");
        outputStream.println("</TABLE>");
    }
        ...
        throws java.io.IOException
    {
        ...
        outputStream.println("<TABLE>");
        String s = TextUtils.getValue(hashmap, "_server").toLowerCase();
    ...
    void printAdvancedProperties(jgl.HashMap hashmap, jgl.HashMap hashmap1)
    {
        ...
        if(s1.length() == 0)
        {
            s1 = Machine.osToString(com.dragonflow.SiteView.Platform.getLocalPlatform());
        }
        outputStream.println("<TABLE>");
        outputStream.println("<TR><TD ALIGN=RIGHT></TD><TD><TABLE><TR><TD ALIGN=LEFT><input type=checkbox name=disabled size=50 " + (com.dragonflow.Page.portalServerPage.getValue(hashmap, "_disabled").length() <= 0 ? "" : "checked") + ">Disable</TD></TR>" + "<TR><TD><FONT SIZE=-1>temporarily disable downloads from this SiteView server</FONT></TD></TR>" + "</TABLE></TD><TD><I>" + TextUtils.getValue(hashmap1, "debug") + "</I></TD></TR>");
        outputStream.println("<TR><TD ALIGN=RIGHT>User Name</TD><TD><TABLE><TR><TD ALIGN=LEFT><input type=text name=username size=50 value=\"" + com.dragonflow.Page.portalServerPage.getValue(hashmap, "_username") + "\"></TD></TR>" + "<TR><TD><FONT SIZE=-1>optional user name for connecting to the SiteView server, the default is to use the administrator user name</FONT></TD></TR>" + "</TABLE></TD><TD><I>" + TextUtils.getValue(hashmap1, "username") + "</I></TD></TR>");
        outputStream.println("<TR><TD ALIGN=RIGHT>Password</TD><TD><TABLE><TR><TD ALIGN=LEFT><input type=password name=password size=50 value=\"" + com.dragonflow.Page.portalServerPage.getValue(hashmap, "_password") + "\"></TD></TR>" + "<TR><TD><FONT SIZE=-1>optional password for connecting to the SiteView server, the default is to use the administrator password</FONT></TD></TR>" + "</TABLE></TD><TD><I>" + TextUtils.getValue(hashmap1, "password") + "</I></TD></TR>");
        outputStream.println("<TR><TD ALIGN=RIGHT>Proxy</TD><TD><TABLE><TR><TD ALIGN=LEFT><input type=text name=proxy size=50 value=\"" + com.dragonflow.Page.portalServerPage.getValue(hashmap, "_proxy") + "\"></TD></TR>" + "<TR><TD><FONT SIZE=-1>optional proxy server to use including port number (for example, proxy." + com.dragonflow.SiteView.Platform.exampleDomain + ":8080)</FONT></TD></TR>" + "</TABLE></TD><TD><I>" + TextUtils.getValue(hashmap1, "proxy") + "</I></TD></TR>");
        outputStream.println("<TR><TD ALIGN=RIGHT>Proxy User Name</TD><TD><TABLE><TR><TD ALIGN=LEFT><input type=text name=proxyusername size=50 value=\"" + com.dragonflow.Page.portalServerPage.getValue(hashmap, "_proxyusername") + "\"></TD></TR>" + "<TR><TD><FONT SIZE=-1>optional user name for connecting through a proxy server</FONT></TD></TR>" + "</TABLE></TD><TD><I>" + TextUtils.getValue(hashmap1, "proxyusername") + "</I></TD></TR>");
        outputStream.println("<TR><TD ALIGN=RIGHT>Proxy Password</TD><TD><TABLE><TR><TD ALIGN=LEFT><input type=password name=proxypassword size=50 value=\"" + com.dragonflow.Page.portalServerPage.getValue(hashmap, "_proxypassword") + "\"></TD></TR>" + "<TR><TD><FONT SIZE=-1>optional password for connecting through a proxy server</FONT></TD></TR>" + "</TABLE></TD><TD><I>" + TextUtils.getValue(hashmap1, "proxypassword") + "</I></TD></TR>");
    ...
    jgl.HashMap fillInResultFrame(jgl.HashMap hashmap)
    {
        ...
        if(TextUtils.getValue(hashmap, "_platformOS").length() == 0)
        {
    ...
    void printListItem(jgl.HashMap hashmap)
    {
        ...
        if(TextUtils.getValue(hashmap, "_readOnly").length() > 0)
        {
            s6 = "";
        }
        String s7 = "&nbsp;";
    ...
    {
        hashmap1.put("_id", com.dragonflow.Page.portalServerPage.createUniqueID(TextUtils.getValue(hashmap1, "_server")));
    }
    ...
    public static void syncRemoteSiteView(jgl.HashMap hashmap, java.io.PrintWriter printwriter)
    {
        ...
        printwriter.println("<H2>Reading configuration from " + TextUtils.getValue(hashmap, "_title") + "</H2>\n");
