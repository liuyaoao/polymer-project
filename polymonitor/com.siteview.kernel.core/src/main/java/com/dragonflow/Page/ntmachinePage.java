...
public class ntmachinePage extends com.dragonflow.Page.remoteBase
{
    ...
    public int checkNTPermissions(com.dragonflow.SiteView.Machine machine, boolean flag)
    {
        int i = 0;
        jgl.Array array = new Array();
        i = Platform.CheckPermissions(machine.getProperty(com.dragonflow.SiteView.Machine.pHost), getMasterConfig(), array);
        if(flag)
        {
            ...
            i = Platform.readProcessList(array, machine.getProperty(com.dragonflow.SiteView.Machine.pHost), new CounterLock(1), false);
            String s1;
