...
public class portalManagePage extends com.dragonflow.Page.portalChooserPage
{
        ...
        throws java.lang.Exception
    {
        ...
        if(j >= 0)
        {
            ...
            printProgressMessage(ACTION_NAMES[i] + " " + TextUtils.getValue(hashmap, "_name") + "<BR>");
            if(i == 1)
            {
        ...
        throws java.lang.Exception
    {
        ...
        for(int j = 1; j < array.size(); j++)
        {
            ...
            {
                String s3 = TextUtils.getValue(hashmap, "_group");
                if(s3.length() != 0)
                {
                    modifyGroup(s3, i, as);
                }
            ...
            refreshMonitor(s, TextUtils.getValue(hashmap, "_id"), i);
        }
