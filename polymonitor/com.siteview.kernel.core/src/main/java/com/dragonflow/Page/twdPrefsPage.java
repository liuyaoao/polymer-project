...
//            String s2 = TextUtils.getValue(hashmap1, "hostname");
//            String s3 = TextUtils.getValue(hashmap1, "hostlocation");
//            int k = com.dragonflow.Utils.TextUtils.toInt(TextUtils.getValue(hashmap1, "HostType"));
