...
public class vMachinePage extends com.dragonflow.Page.prefsPage {
    ...
    public static boolean createGroupFromRequest(String s, String s1,
        ...
        if (s3 != null && s3.length() != 0) {
            ...
            try {
                ...
                String s5 = TextUtils.getValue(hashmap,
                        "_nextID");
                if (s5.length() == 0) {
                    s5 = "1";
                }
    ...
    void changeDynamicSet(jgl.HashMap hashmap) {
        adjustDynamicConfig(hashmap, TextUtils.getValue(
                hashmap, "_id"));
    }
    ...
    void adjustDynamicConfig(jgl.HashMap hashmap, String s) {
        ...
        if (hashmap != null && s == null) {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                String s1 = TextUtils.getValue(hashmap2,
                        "_id");
                if (s1 != null
                        && s1.equals(s)
    ...
    void displayForm(jgl.HashMap hashmap, String s) {
        java.util.Vector vector = SiteViewGroup
        ...
        String s5 = TextUtils.getValue(hashmap, "_parent");
        try {
        ...
        String s6 = TextUtils.getValue(hashmap,
                "_frequency");
        if (s6.length() <= 0) {
            s6 = "21600";
        }
        ...
        String s7 = TextUtils.getValue(hashmap,
                "_excludeIP");
        outputStream
                .println(com.dragonflow.Page.vMachinePage
                        .field(
        ...
        com.dragonflow.SiteView.SiteViewGroup siteviewgroup = SiteViewGroup
                .currentSiteView();
        Enumeration enumeration = siteviewgroup
        ...
        String s9 = TextUtils.getValue(hashmap, "_oid");
        s1 = "";
        ...
        String s12 = TextUtils.getValue(hashmap,
                "_community");
        if (s12.length() <= 0) {
            s12 = "public";
        }
        ...
        String s13 = TextUtils.getValue(hashmap,
                "_dbDriver");
        if (s13.length() <= 0) {
        ...
        com.dragonflow.Properties.StringProperty.getPrivate(
                TextUtils.getValue(hashmap, "_dbPassword"),
        ...
        String s14 = TextUtils.getValue(hashmap,
                "_dbConnectTimeout");
        if (s14.length() <= 0) {
            s14 = "60";
        }
        ...
        String s15 = TextUtils.getValue(hashmap,
                "_dbQueryTimeout");
        if (s15.length() <= 0) {
            s15 = "60";
        }
    ...
    public static jgl.HashMap findDynamicFrame(String s) {
        ...
        try {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                String s1 = TextUtils.getValue(hashmap1,
                        "_id");
                if (s1.equals(s)) {
                    hashmap = hashmap1;
                }
    ...
    jgl.Array getListTableRow(jgl.HashMap hashmap) {
        ...
        if (s1.length() == 0) {
            s1 = TextUtils.getValue(hashmap, "_host");
        }
        if (s1.length() <= 0) {
            s1 = TextUtils.getValue(hashmap,
                    "_dbConnectionURL");
        }
        array.add(new String(s1));
        array.add(new String(TextUtils.getValue(hashmap,
    ...
    static {
        dynamicFilePath = Platform.getRoot()
                + java.io.File.separator + "groups" + java.io.File.separator
                + "dynamic.config";
    }
}
