...
import com.dragonflow.SiteView.Server;
...
public class overviewPage extends com.dragonflow.Page.CGI
{
        ...
        throws java.lang.Exception
    {
        ...
        {
            s2 = "Update";
            hashmap1 = Server.findServer(array, s1);
        } else
        {
            s2 = "Add to ";
        ...
        if(TextUtils.getValue(hashmap1, "timeout").length() == 0)
        {
        ...
        throws java.lang.Exception
    {
        ...
        String s1 = request.getValue("server");
        jgl.Array array = Server.readServers();
        if(request.isPost())
        {
            ...
            {
                jgl.HashMap hashmap1 = Server.findServer(array, request.getValue("originalServer"));
        ...
        throws java.io.IOException
    {
        ...
        if(s3.length() > 0)
        {
            jgl.HashMap hashmap = Server.findServer(com.dragonflow.SiteView.Server.readServers(), s3);
            String s4 = "";
            String s5 = "Servers";
            String s6 = s3;
            if(hashmap != null)
            {
                ...
                jgl.HashMap hashmap3 = Server.findServer(com.dragonflow.SiteView.Server.readServers(), s4);
                if(hashmap3 != null)
                {
        ...
        jgl.Array array = Server.getServers(s3, true);
        ...
        do
        {
            ...
            if(TextUtils.getValue(hashmap2, "hidden").length() == 0)
            {
                String s8 = "";
                ...
                String s9 = TextUtils.getValue(hashmap2, "server");
    ...
    boolean isRelated(jgl.HashMap hashmap, String s, jgl.Array array)
    {
        ...
        jgl.HashMap hashmap1 = Server.findServer(array, s);
        if(hashmap1 == null)
        {
            return false;
        } else
    ...
    public void printServers()
    {
        ...
        jgl.Array array1 = Server.getServers("", true);
        ...
        do
        {
            ...
            jgl.HashMap hashmap1 = (jgl.HashMap)enumeration.nextElement();
            if(TextUtils.getValue(hashmap1, "hidden").length() == 0)
            {
                String s4;
                if(request.actionAllowed("_multiEdit"))
                {
                    s4 = TextUtils.getValue(hashmap1, "overviewHideAdminGroups");
                } else
                {
                    s4 = TextUtils.getValue(hashmap1, "overviewHideUserGroups");
                }
                if(TextUtils.getValue(hashmap1, "usage").indexOf("monitorcount") < 0)
                {
...
label0:
    ...
    static long fetchSiteSeerState(jgl.HashMap hashmap, StringBuffer stringbuffer)
    {
        ...
        hashmap1.put("account", TextUtils.getValue(hashmap, "_siteseerAccount"));
        hashmap1.put("username", TextUtils.getValue(hashmap, "_siteseerUsername"));
        hashmap1.put("password", TextUtils.getValue(hashmap, "_siteseerPassword"));
        hashmap1.put("title", TextUtils.getValue(hashmap, "_siteseerTitle"));
        hashmap1.put("server", TextUtils.getValue(hashmap, "_siteseerHost"));
        hashmap1.put("proxy", TextUtils.getValue(hashmap, "_siteseerProxy"));
        hashmap1.put("proxyusername", TextUtils.getValue(hashmap, "_siteseerProxyUsername"));
        hashmap1.put("proxypassword", TextUtils.getValue(hashmap, "_siteseerProxyPassword"));
    ...
    public static String fetchSiteSeerCategory(jgl.HashMap hashmap)
    {
        ...
        if(l == 200L)
        {
            String s1 = TextUtils.getValue(hashmap, "_siteseerAccount");
            ...
            if(i >= 0 && j >= 0)
            {
                ...
                {
                    jgl.Array array = Platform.split('\t', as[k]);
                    if(array.size() <= 3)
                    {
                        continue;
                    }
            ...
            String s1, boolean flag2, String s2, String s3)
    {
        ...
        boolean flag3 = TextUtils.getValue(hashmap, "_siteseerAccount").length() > 0 && TextUtils.getValue(hashmap, "_siteseerDisabled").length() == 0 && s4.equals("_local");
        long l;
        String s6;
        if(s4.equals("_local"))
        {
        ...
        {
            l = com.dragonflow.Utils.TextUtils.toLong(TextUtils.getValue(hashmap1, "_status"));
            stringbuffer.append(TextUtils.getValue(hashmap1, "_contents"));
            String s8 = TextUtils.getValue(hashmap1, "securehttp");
            if(s8.length() > 0)
            {
        ...
        if(l == 200L)
        {
            ...
            if(i >= 0 && k >= 0)
            {
                ...
                if(flag3)
                {
                    ...
                    {
                        com.dragonflow.Log.LogManager.log("RunMonitor", "unknown multi-view page error, " + TextUtils.getValue(hashmap, "_siteseerAccount") + ", " + stringbuffer1);
            ...
            String s4, String s5, boolean flag1, String s6, String s7)
    {
        ...
        jgl.HashMap hashmap = new HashMap();
        jgl.Array array3 = Server.readServers();
        jgl.HashMap hashmap1 = Server.findServer(array3, s2);
        ...
        {
            jgl.Array array4 = Platform.split('\t', as[i]);
            if(array4.size() < 3)
            {
                continue;
            }
...
label0:
                ...
                } else
                {
                    ...
                    if(k == -1 || k >= k1)
                    {
                        ...
                        } else
                        {
                            ...
                            s7 = Monitor.getWorstCategory(s7, s13);
    ...
    String getPreferenceOptionsHTML()
    {
        ...
        for(Enumeration enumeration1 = array.elements(); enumeration1.hasMoreElements(); stringbuffer.append("<option value=\"" + s + "\">" + s + "=" + s1 + ""))
        {
            ...
            s1 = TextUtils.getValue(hashmap, s);
        ...
        throws java.lang.Exception
    {
            ...
            try
            {
                ...
                if(s.equals("Replace Preference"))
                {
                    ...
                    while(enumeration1.hasMoreElements()) 
                    {
                        ...
                        StringBuffer stringbuffer1 = new StringBuffer();
                        StringBuffer stringbuffer2 = new StringBuffer();
                        long l1 = Server.remoteOp(hashmap1, "get", "/groups/master.config", stringbuffer1, stringbuffer2);
                        if(l1 != 200L)
                        {
                        ...
                        } else
                        {
                            ...
                            } else
                            {
                                ...
                                } else
                                {
                                    ...
                                    long l2 = Server.remoteOp(hashmap1, "put", "/groups/master.config", stringbuffer4, stringbuffer5);
                                    if(l2 != 200L)
                                    {
                ...
                if(s.equals("Replace Configuration File"))
                {
                    ...
                    } else
                    {
                        ...
                        while(enumeration2.hasMoreElements()) 
                        {
                            ...
                            StringBuffer stringbuffer3 = new StringBuffer();
                            long l3 = Server.remoteOp(hashmap4, "put", s8, stringbuffer, stringbuffer3);
                            if(l3 != 200L)
                            {
        ...
        } else
        {
            ...
            for(int l = 0; l < array1.size(); l++)
            {
                ...
                if(TextUtils.getValue(hashmap2, "_user").equals(s15))
                {
                    hashmap = hashmap2;
                }
            }
            ...
            do
            {
                ...
                if(s16.startsWith(OPEN_VARIABLE))
                {
                    ...
                    if(!TextUtils.getValue(hashmap, s17).equals("open"))
                    {
                ...
                if(s16.startsWith(CLOSE_VARIABLE))
                {
                    ...
                    if(!TextUtils.getValue(hashmap, s18).equals("close"))
                    {
                        hashmap.remove(s18);
                        flag = true;
                    }
            ...
            jgl.Array array2 = Server.getServers("", false);
    ...
    String getReturnURL()
    {
        ...
        {
            s = Platform.getURLPath("htdocs", request.getAccount()) + "/" + s + ".html";
        }
        return s;
    }
    ...
    {
        String s = Server.getPath(hashmap);
        String s1 = Server.getTitle(hashmap);
        jgl.Array array = Server.loadItems(hashmap);
        ...
        outputStream.print("<input type=checkbox name=item value=\"" + s + "\" " + TextUtils.getValue(hashmap2, s) + "><B>");
