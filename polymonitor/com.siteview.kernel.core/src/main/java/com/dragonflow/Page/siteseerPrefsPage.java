...
public class siteseerPrefsPage extends com.dragonflow.Page.prefsPage
{
    ...
    {
        jgl.HashMap hashmap = getMasterConfig();
        String s = TextUtils.getValue(hashmap, "_siteseerUsername");
        StringBuffer stringbuffer = new StringBuffer();
        StringBuffer stringbuffer1 = new StringBuffer();
        com.dragonflow.Properties.StringProperty.getPrivate(TextUtils.getValue(hashmap, "_siteseerPassword"), "siteseerPassword", "seerSuff", stringbuffer, stringbuffer1);
        String s1 = TextUtils.getValue(hashmap, "_siteseerAccount");
        String s2 = TextUtils.getValue(hashmap, "_siteseerHost").trim();
        if(s2.length() == 0)
        {
        ...
        String s3 = TextUtils.getValue(hashmap, "_siteseerTitle").trim();
        if(s3.length() == 0)
        {
            s3 = "Siteseer";
        }
        String s4 = TextUtils.getValue(hashmap, "_siteseerProxy");
        String s5 = TextUtils.getValue(hashmap, "_siteseerProxyUsername");
        StringBuffer stringbuffer2 = new StringBuffer();
        StringBuffer stringbuffer3 = new StringBuffer();
        com.dragonflow.Properties.StringProperty.getPrivate(TextUtils.getValue(hashmap, "_siteseerProxyPassword"), "siteseerProxyPassword", "pSeerSuff", stringbuffer2, stringbuffer3);
        String s6 = TextUtils.getValue(hashmap, "_siteseerHidden");
        String s7 = TextUtils.getValue(hashmap, "_siteseerDisabled");
        String s8 = TextUtils.getValue(hashmap, "_siteseerLoginInURL");
        String s9 = TextUtils.getValue(hashmap, "_siteseerReadOnlyUsername");
        StringBuffer stringbuffer4 = new StringBuffer();
        StringBuffer stringbuffer5 = new StringBuffer();
        com.dragonflow.Properties.StringProperty.getPrivate(TextUtils.getValue(hashmap, "_siteseerReadOnlyPassword"), "siteseerReadOnlyPassword", "rSeerSuff", stringbuffer4, stringbuffer5);
