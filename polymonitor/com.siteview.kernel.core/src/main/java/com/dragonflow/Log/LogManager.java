...
//    static com.dragonflow.Log.TopazLogger topazLogger = null;
    ...
    public static void initialize(String s, int i, int j, int k, boolean flag, boolean flag1, int l, long l1) {
        ...
        try {
            if (TextUtils.getValue(hashmap, "_createDailyErrorLog").length() > 0) {
        ...
        try {
            if (TextUtils.getValue(hashmap, "_createDailyRunMonitorLog").length() > 0) {
        ...
        try {
            if (TextUtils.getValue(hashmap, "_createDailyAccessLog").length() > 0) {
    ...
    public static void registerLogger(String s, com.dragonflow.Log.Logger logger) {
        boolean flag = false;
...
//                }
        ...
        if (as != null) {
            for (int i = 0; i < as.length; i ++) {
                ...
                try {
                    ...
                    System.out.println("Could not create Custom Logger class " + s + "  " + exception);
                }
            }
    ...
    static {
        ...
        strLoggers = com.dragonflow.Utils.TextUtils.split(TextUtils.getValue(rtConfig, "_loggers").toLowerCase(), ";");
