...
public class ProcessMgr {
    ...
    static {
        ...
        String s = TextUtils.getValue(hashmap, "_processPoolTimeout");
        if (s.length() > 0) {
        ...
        String s1 = TextUtils.getValue(hashmap, "_processPoolMaxPerPool");
        if (s1.length() > 0) {
            maxProcessesPerPool = com.dragonflow.Utils.TextUtils.toInt(s1);
        }
        String s2 = TextUtils.getValue(hashmap, "_processPoolKillTimeout");
        if (s2.length() > 0) {
            processKillTimeout = com.dragonflow.Utils.TextUtils.toInt(s2);
        }
        String s3 = TextUtils.getValue(hashmap, "_processPoolDebugLevel");
        if (s3.length() > 0) {
