...
public class SNMPFlowMonitor extends AtomicMonitor{
	 static StringProperty pHost;
	        ...
	        if (s9.length() == 0) {
	            try {
	                ...
	                while (true) {
						...
						if (Platform.timeMillis() > l1) {//dingbing.xu change <= to > ��������޷�����ѭ��
	                        if (flag3 && !flag) {
	                            session.close();
	                        }
	                        break;
	        ...
	        if (stillActive()) {
	            synchronized (this) {
	                if (s15.length() == 0) {
	                    ...
	                    s24=s7+I18N.StringToUnicode(s24, I18N.nullEncoding());
	                    s24="status=ok, "+s24;
	                    setProperty(pStateString, s24);
	                } else {
	    ...
	    static {
	        ...
	        if (hasSecondOID) {
	            ...
	            addProperties("com.dragonflow.StandardMonitor.SNMPFlowMonitor", astringproperty1);
	        }
	        addClassElement("com.dragonflow.StandardMonitor.SNMPFlowMonitor", Rule.stringToClassifier("status != 'ok'\terror"));
	        addClassElement("com.dragonflow.StandardMonitor.SNMPFlowMonitor", Rule.stringToClassifier("status == 'ok'\tgood"));
	        setClassProperty("com.dragonflow.StandardMonitor.SNMPFlowMonitor", "description", "Returns the value of an SNMP get.");
	        setClassProperty("com.dragonflow.StandardMonitor.SNMPFlowMonitor", "help", "SNMPMon.htm");
	        setClassProperty("com.dragonflow.StandardMonitor.SNMPFlowMonitor", "title", "SNMPFlow");
	        setClassProperty("com.dragonflow.StandardMonitor.SNMPFlowMonitor", "class", "SNMPFlowMonitor");
	        setClassProperty("com.dragonflow.StandardMonitor.SNMPFlowMonitor", "target", "_host");
	        setClassProperty("com.dragonflow.StandardMonitor.SNMPFlowMonitor", "topazName", "SNMPFlow");
	        setClassProperty("com.dragonflow.StandardMonitor.SNMPFlowMonitor", "toolName", "SNMPFlow");
	        setClassProperty("com.dragonflow.StandardMonitor.SNMPFlowMonitor", "toolDescription", "Walks an SNMP mib.");
	        setClassProperty("com.dragonflow.StandardMonitor.SNMPFlowMonitor", "topazType", "System Resources");
	        try {
