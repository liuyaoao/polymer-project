...
public class BandwidthMonitor extends AtomicMonitor
{
 ...
 protected void updateStats(double ad[], String as[], Monitor monitor, int i)
 {
     ...
     do
     {
         ...
         if(stringproperty.getName().equals("snmpValue") || stringproperty.getName().equals("result") || stringproperty.getName().equals("value")
        		 || stringproperty.getName().equals("value0") || stringproperty.getName().equals("column1")||stringproperty.getName().equals("intvalue1")||stringproperty.getName().equals("intvalue2"))
         {
