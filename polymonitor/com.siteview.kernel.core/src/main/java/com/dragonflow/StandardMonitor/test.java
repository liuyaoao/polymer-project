...
public class test extends AtomicMonitor
{
    ...
    protected boolean update()
    {
        ...
        int i1 = ai[1];
        int j1 = ai[0];
        currentStatus = "test analyzing results...";
        if(stillActive())
            synchronized(this)
            {
                if(i1 > 0)
    ...
    static 
    {
        ...
        addProperties("com.dragonflow.StandardMonitor.test", astringproperty);
        addClassElement("com.dragonflow.StandardMonitor.test", Rule.stringToClassifier("percentGood == 0\terror", true));
        addClassElement("com.dragonflow.StandardMonitor.test", Rule.stringToClassifier("roundTripTime == n/a\terror"));
        addClassElement("com.dragonflow.StandardMonitor.test", Rule.stringToClassifier("percentGood < 100\twarning", true));
        addClassElement("com.dragonflow.StandardMonitor.test", Rule.stringToClassifier("percentGood == 100\tgood", true));
        setClassProperty("com.dragonflow.StandardMonitor.test", "description", "Pings a device on the network.");
        setClassProperty("com.dragonflow.StandardMonitor.test", "help", "PingMon.htm");
        setClassProperty("com.dragonflow.StandardMonitor.test", "title", "Ping");
        setClassProperty("com.dragonflow.StandardMonitor.test", "class", "test");
        setClassProperty("com.dragonflow.StandardMonitor.test", "target", "_hostname");
        setClassProperty("com.dragonflow.StandardMonitor.test", "toolName", "Ping");
        setClassProperty("com.dragonflow.StandardMonitor.test", "toolDescription", "Performs a roundtrip test on the network.");
        setClassProperty("com.dragonflow.StandardMonitor.test", "topazName", "Ping");
        setClassProperty("com.dragonflow.StandardMonitor.test", "topazType", "System Resources");
    }
}