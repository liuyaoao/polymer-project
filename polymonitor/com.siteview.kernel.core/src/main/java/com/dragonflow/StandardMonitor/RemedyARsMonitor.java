...
//            s_pRemedySchemaDefinitionFile = new StringProperty("_remedySchemaDefinitionFile", Configuration.getConfigPath() + "Remedy.def");
...
//            s_pEmsConfigFilePath = new EmsConfigFileProperty(Configuration.MONITOR_NAME);
