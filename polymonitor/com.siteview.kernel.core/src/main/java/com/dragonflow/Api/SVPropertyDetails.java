...
public class SVPropertyDetails extends com.dragonflow.Api.SVBaseReturnValues
{
    ...
    public SVPropertyDetails(String s, String s1, String s2, String s3, boolean flag, boolean flag1, String s4, 
    ...
    public static void extractDetailsIntoHashMap(com.dragonflow.Api.SVPropertyDetails sspropertydetails, jgl.HashMap hashmap)
    {
