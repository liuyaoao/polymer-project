...
// SSBaseReturnValues
public class SVAlertInstanceInfo extends com.dragonflow.Api.SVBaseReturnValues {
    ...
    public SVAlertInstanceInfo(String s, String s1, String s2, String s3, String s4, String s5) {
        name = s;
        alertFullId = s1;
        alertId = s2;
        groupId = s3;
