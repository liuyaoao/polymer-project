...
REM * In order to be invoked by a SiteView script monitor, this file should reside under the 'templates.applications\scripts.siebel' directory of SiteView.			* 
REM * 															      		      	 				*
REM * Usage example: 															      	 				*
REM * C:\SiteView\templates.applications\scripts.siebel\change_siebel_db_log_level.bat C:\sea752\tools\client\BIN sblgw siebel_ent sblapp1 sadmin sadmin enable sccobjmgr_enu 	*
REM * 															      		      	 				*
REM * Operation exit code is passed to SiteView monitor. Possible exit codes:									 				*
