...
public class Server {
    ...
    public static final String STORAGE_FILE_PATH = System.getProperty("user.dir") +
            File.separator + "moquette_store.mapdb";
    
    public static String CUR_FILE_PATH = null;
    
    public static String PROPERTIES_PATH = "config/moquette.conf";
    ...
    public void startServer() throws IOException {
        ...
        startServer(new File(configPath));
    }
    ...
    public void startServer(File configFile) throws IOException {
        ...
        System.setProperty("moquette.port",configProps.getProperty("port"));
