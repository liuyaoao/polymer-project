...
if fpwcheckilpass==1
  ...
  elseif strcmp(outrunindex,'411')
    ...
    %save c:\matlab\pattern\mybug20160725.mat
  ...
  elseif strcmp(outrunindex,'418')
    ...
    if strcmp(instruct.Pzhu112,'1')==1 % load weights
      if exist([fpwserverplace,fpwclientdirectory,fpwusername,'\pattern\portpme1.mat'])~=2
        ...
        eval(['save ',fpwserverplace,fpwclientdirectory,fpwusername,'\pattern\portpme1.mat portpme1']);
      else
    ...
    elseif strcmp(instruct.Pzhu112,'2')==1 % load overlaps
      if exist([fpwserverplace,fpwclientdirectory,fpwusername,'\pattern\portpme2.mat'])~=2
        ...
        eval(['save ',fpwserverplace,fpwclientdirectory,fpwusername,'\pattern\portpme2.mat portpme2']);
      else
      ...
      if exist([fpwserverplace,fpwclientdirectory,fpwusername,'\pattern\portpme3.mat'])~=2
        ...
        eval(['save ',fpwserverplace,fpwclientdirectory,fpwusername,'\pattern\portpme3.mat portpme3']);
      else
    ...
    smps2.StatusReport = ['Data loaded from file ',noempty(pmefilename),' successfully. ',time1];
