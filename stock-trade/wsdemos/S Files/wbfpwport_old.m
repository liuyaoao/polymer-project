...
if fpwcheckilpass==1
  ...
  elseif strcmp(outrunindex,'412')
    ...
    fpwport.Pzhu300=instruct.hdPzhu300;
  ...
  elseif strcmp(outrunindex,'413')
    ...
    Tradeh=[]; Tradeh2=[]; Tradeh3=[]; Tradeo=[]; Tradeeach=[]; zhusc75=zeros(99,1);
  ...
  elseif strcmp(outrunindex,'416')
    ...
    zhusc75=zeros(99,1); % only used by LABAC(ii,3) in wbfpwoutput
